    ...
    <div class="container">
        ...
        <div class="courses-grid">
            ...
            <div class="course-card">
                ...
                <div class="course-content">
                    ...
                    <a href="#" class="course-more-link">詳細を見る →</a>
                </div>
            </div>
        ...
        <div class="other-courses">
            ...
            <ul class="other-courses-list">
                <li><a href="#">ボイストレーニングコース</a></li>
                <li><a href="#">ソルフェージュコース</a></li>
                <li><a href="#">受験コース</a></li>
            </ul>
            <a href="#" class="btn course-all-btn">全コースを見る</a>
        </div>
    </div>
</section>